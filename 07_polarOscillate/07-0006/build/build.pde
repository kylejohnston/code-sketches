...
void setup() {
	...
	pool.autoParent(canvas)
		...
		.add(new HEllipse().size(2).anchor(14,14).stroke(#00FF00).noFill().alpha(50))
		.add(new HEllipse().size(2).anchor(14,14).stroke(#0072CE).noFill().alpha(50))
		.add(new HEllipse().size(2).anchor(14,14).stroke(#FFFFFF).noFill().alpha(50))
